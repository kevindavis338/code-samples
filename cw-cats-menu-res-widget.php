...
/*
Plugin Name: Cancer Wellness Category Listing for the Mega Menu by Resources
...
function cw_cats_load_menu_res_widget() {
    register_widget( 'cw_cats_menu_res_widget' );
}
add_action( 'widgets_init', 'cw_cats_load_menu_res_widget' );

// Creating the cw categories widget 
class cw_cats_menu_res_widget extends WP_Widget {
 
	function __construct() {
		parent::__construct(
		
		// Base ID of your widget
		'cw_cats_menu_res_widget', 
		
		// Widget name will appear in UI
		__('Cancer Wellness Categories for the Resources', 'cw_cats_widget_domain'), 
		
		// Widget description
		array( 'description' => __( 'The widget for the to show the category in the Mega Menu by Resources', 'cw_cats_widget_domain' ), ) 
		);
	}
